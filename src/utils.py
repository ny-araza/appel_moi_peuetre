...
def get_function_name(
    ...
    for i, prompt in enumerate(prompt_list, 1):
        temp_prompt = [
                ...
                "2. Choose ONE SINGLE function from the list, the one that best matches the request.\n"
                "3. Reply ONLY with the exact function name, "
                "copied as-is from the list (respect spelling and the 'fn_' prefix).\n"
                "4. Do not add any explanation, punctuation, or extra words.\n"
                "5. Never answer with a full sentence, only the function name.\n\n"
                "Examples:\n"
